...
if (story) {
  ...
  const stages = {
    connect: frame('01 / CONNECT YOUR PROJECT', 'Connect Your Project', 'PLANNED CONNECTION',
      'Start with your website or a public GitHub link. The future audit will inspect it with read-only access and show what to do next.',
      ...
      `<div class="story-simple-head"><span>THE PATH AHEAD</span>${badge('PREVIEW')}</div><div class="story-simple-path"><div><b>1</b><span><strong>Share a link</strong><small>Your website or public project</small></span></div><div><b>2</b><span><strong>See what matters</strong><small>Strengths, risks, and unknowns</small></span></div><div><b>3</b><span><strong>Choose your next step</strong><small>A recommendation grounded in evidence</small></span></div></div><div class="story-truth">Illustrative path. No scan has run.</div>`),
