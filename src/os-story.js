...
if (story) {
  ...
  const stages = {
    connect: frame('01 / CONNECT YOUR PROJECT', 'Start with your project.', 'PUBLIC FIRST LOOK',
      ...
      `<div class="story-connect-card"><span class="story-connect-icon" aria-hidden="true">◉</span><strong>Start with what is live</strong><small>Website, web app, GitHub, or app listing</small><div class="story-connect-input">your-public-link.com <span>PUBLIC SOURCE</span></div><a href="#free-audit" data-fsai-event="home_audit_jump" data-fsai-placement="home_demo">Run the free audit →</a></div>`,
